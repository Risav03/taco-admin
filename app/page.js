...
const RaffleDashBoard = () => {
  ...
  async function setRaffle(){
    ...
    const txn = await contract.setRaffleItem(activeRaffles, contractAdd, limitPerWallet, link, tokenId, allowedTickets, ethers.utils.parseEther(guacCost));
  ...
  return (
    <div className='w-[90%] mt-20 min-[1600px]:mt-32 mx-auto min-[1600px]:gap-10'>
        <div className='flex flex-wrap gap-2 items-center justify-center'>
          ...
          <div className='bg-yellow-500 border-4 border-black rounded-xl p-10'>
            <div className='flex flex-col justify-center items-center w-full gap-5'>
                ...
                <div className='w-full'>
                    ...
                    <input onChange={(e)=>{setGuacCost(e.target.value)}} value={guacCost} type="text" className='px-4 h-12 w-full rounded-lg bg-white text-lg border-2 border-black' />
                </div>
...
const RaffleComp = ({data}) => {
  ...
  const [limitPerWallet, setLimitPerWallet] = useState(null);
  const [allowedTickets, setAllowedTickets] = useState(null);
  const [guacCost, setGuacCost] = useState("");
  ...
  useEffect(()=>{
    ...
    setGuacCost(String(ethers.utils.formatEther(String(data[7]))))
    setLink(data[8])
    setImage(data[10]);
    ...
    return(
        <div className="">
            <div className=' bg-yellow-500 border-4 border-black rounded-xl p-2 w-full flex flex-col items-center justify-center '>
          ...
          <div className='w-[100%] text-center'>
            ...
            <div className='flex flex-col gap-2'>
              ...
              <h2 className='text-sm font-semibold truncate'>Guac Cost: {guacCost} $GUAC </h2>
